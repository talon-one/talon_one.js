...
**experimentVariantAllocations** | [**[ExperimentVariantAllocation]**](ExperimentVariantAllocation.md) | The experiment variant allocations to add to this session.  | [optional] 
...
**updateCount** | **Number** | The number of times the session was updated. When the session is created, this value is initialized to &#x60;1&#x60;. | 
