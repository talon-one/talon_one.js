...
var LoyaltyProgram = /*#__PURE__*/function () {
   ...
   */
  function LoyaltyProgram(id, accountID, name, title, description, subscribedApplications, defaultValidity, defaultPending, allowSubledger) {
  ...
  _createClass(LoyaltyProgram, null, [{
    key: "initialize",
    value: function initialize(obj, id, accountID, name, title, description, subscribedApplications, defaultValidity, defaultPending, allowSubledger) {
      obj['id'] = id;
