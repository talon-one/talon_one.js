...
var AddLoyaltyPointsEffectProps = /*#__PURE__*/function () {
   ...
   */
  function AddLoyaltyPointsEffectProps(name, programId, subLedgerId, value, recipientIntegrationId) {
  ...
  _createClass(AddLoyaltyPointsEffectProps, null, [{
    key: "initialize",
    value: function initialize(obj, name, programId, subLedgerId, value, recipientIntegrationId) {
      obj['name'] = name;
