...
var _AttributesMandatory = _interopRequireDefault(require("./AttributesMandatory"));
...
var AttributesSettings = /*#__PURE__*/function () {
  ...
  function AttributesSettings() {
    _classCallCheck(this, AttributesSettings);
  ...
  _createClass(AttributesSettings, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('mandatory')) {
          obj['mandatory'] = _AttributesMandatory["default"].constructFromObject(data['mandatory']);
        }
      }
...
var _default = AttributesSettings;
