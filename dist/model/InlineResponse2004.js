...
var InlineResponse2004 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse2004(totalResultSize, data) {
    _classCallCheck(this, InlineResponse2004);

    InlineResponse2004.initialize(this, totalResultSize, data);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_Ruleset["default"]]);
        }
      }
