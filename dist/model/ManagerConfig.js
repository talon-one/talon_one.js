...
var ManagerConfig = /*#__PURE__*/function () {
   ...
   */
  function ManagerConfig(schemaVersion) {
    _classCallCheck(this, ManagerConfig);
  ...
  _createClass(ManagerConfig, null, [{
    key: "initialize",
    value: function initialize(obj, schemaVersion) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('schemaVersion')) {
          obj['schemaVersion'] = _ApiClient["default"].convertToType(data['schemaVersion'], 'Number');
        }
      }
