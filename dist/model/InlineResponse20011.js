...
var _CampaignAnalytics = _interopRequireDefault(require("./CampaignAnalytics"));
...
var InlineResponse20011 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse20011(totalResultSize, data) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_CampaignAnalytics["default"]]);
        }
      }
