    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('validityDuration')) {
          obj['validityDuration'] = _ApiClient["default"].convertToType(data['validityDuration'], 'String');
        }

        if (data.hasOwnProperty('pendingDuration')) {
          obj['pendingDuration'] = _ApiClient["default"].convertToType(data['pendingDuration'], 'String');
        }
