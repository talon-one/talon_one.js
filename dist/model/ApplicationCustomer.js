...
var _AudienceMembership = _interopRequireDefault(require("./AudienceMembership"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('audienceMemberships')) {
          obj['audienceMemberships'] = _ApiClient["default"].convertToType(data['audienceMemberships'], [_AudienceMembership["default"]]);
        }
