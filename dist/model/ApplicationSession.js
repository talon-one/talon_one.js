...
var ApplicationSession = /*#__PURE__*/function () {
   ...
   */
  function ApplicationSession(id, created, applicationId, integrationId, coupon, referral, state, cartItems, discounts, total) {
  ...
  _createClass(ApplicationSession, null, [{
    key: "initialize",
    value: function initialize(obj, id, created, applicationId, integrationId, coupon, referral, state, cartItems, discounts, total) {
      obj['id'] = id;
      obj['created'] = created;
