 ...
 * @version 4.2.0
 */
var AdditionalCost = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AdditionalCost</code>.
   * @alias module:model/AdditionalCost
   * @param price {Number} 
   */
  function AdditionalCost(price) {
    _classCallCheck(this, AdditionalCost);
  ...
  _createClass(AdditionalCost, null, [{
    key: "initialize",
    value: function initialize(obj, price) {
      obj['price'] = price;
    }
    /**
