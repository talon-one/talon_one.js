 ...
 * @version 4.2.0
 */
var NewEventType = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewEventType(applicationIds, title, name, description, mimeType, handler, version) {
    _classCallCheck(this, NewEventType);
  ...
  _createClass(NewEventType, null, [{
    key: "initialize",
    value: function initialize(obj, applicationIds, title, name, description, mimeType, handler, version) {
