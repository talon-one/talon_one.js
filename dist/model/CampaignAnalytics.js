    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('addedLoyaltyPoints')) {
          obj['addedLoyaltyPoints'] = _ApiClient["default"].convertToType(data['addedLoyaltyPoints'], 'Number');
        }

        if (data.hasOwnProperty('totalAddedLoyaltyPoints')) {
          obj['totalAddedLoyaltyPoints'] = _ApiClient["default"].convertToType(data['totalAddedLoyaltyPoints'], 'Number');
        }

        if (data.hasOwnProperty('deductedLoyaltyPoints')) {
          obj['deductedLoyaltyPoints'] = _ApiClient["default"].convertToType(data['deductedLoyaltyPoints'], 'Number');
        }

        if (data.hasOwnProperty('totalDeductedLoyaltyPoints')) {
          obj['totalDeductedLoyaltyPoints'] = _ApiClient["default"].convertToType(data['totalDeductedLoyaltyPoints'], 'Number');
        }
      }
