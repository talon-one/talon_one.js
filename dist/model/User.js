...
var User = /*#__PURE__*/function () {
   ...
   */
  function User(id, created, modified, email, accountId, inviteToken, state, name, policy, releaseUpdate) {
  ...
  _createClass(User, null, [{
    key: "initialize",
    value: function initialize(obj, id, created, modified, email, accountId, inviteToken, state, name, policy, releaseUpdate) {
      obj['id'] = id;
      obj['created'] = created;
