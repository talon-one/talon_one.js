...
class BaseNotificationWebhook {
     ...
     */
    constructor(id, created, modified, url, headers) { 
        
        BaseNotificationWebhook.initialize(this, id, created, modified, url, headers);
    }
     ...
     */
    static initialize(obj, id, created, modified, url, headers) { 
        obj['id'] = id;
        obj['created'] = created;
    ...
    /**
     * Constructs a <code>BaseNotificationWebhook</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseNotificationWebhook} obj Optional instance to populate.
     * @return {module:model/BaseNotificationWebhook} The populated <code>BaseNotificationWebhook</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BaseNotificationWebhook();
 ...
 * @member {Date} created
 */
BaseNotificationWebhook.prototype['created'] = undefined;

/**
 * The time this entity was last modified.
 * @member {Date} modified
 */
BaseNotificationWebhook.prototype['modified'] = undefined;

/**
 * API URL for the given webhook-based notification.
 * @member {String} url
 */
BaseNotificationWebhook.prototype['url'] = undefined;
...
export default BaseNotificationWebhook;
