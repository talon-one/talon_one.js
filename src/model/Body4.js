...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.Body4 = factory(root.TalononeApi.ApiClient, root.TalononeApi.InlineResponse2001CouponSettings, root.TalononeApi.InlineResponse2001Limits);
  }
   ...
   * @param state {module:model/Body4.StateEnum} A disabled or archived campaign is not evaluated for rules or coupons. 
   * @param tags {Array.<String>} A list of tags for the campaign.
   * @param features {Array.<module:model/Body4.FeaturesEnum>} A list of features for the campaign.
   ...
   * @member {module:model/Body4.StateEnum} state
   * @default 'enabled'
   */
   ...
   * @member {Array.<module:model/Body4.FeaturesEnum>} features
   */
