...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.InlineResponse20027Data = factory(root.TalononeApi.ApiClient);
  }
   ...
   * @param state {module:model/InlineResponse20027Data.StateEnum} Current user state.
  ...
  /**
   * Current user state.
   * @member {module:model/InlineResponse20027Data.StateEnum} state
   */
