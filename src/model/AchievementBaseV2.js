...
class AchievementBaseV2 {
    /**
     * Constructs a new <code>AchievementBaseV2</code>.
     * @alias module:model/AchievementBaseV2
     */
    constructor() { 
        
        AchievementBaseV2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AchievementBaseV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AchievementBaseV2} obj Optional instance to populate.
     * @return {module:model/AchievementBaseV2} The populated <code>AchievementBaseV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AchievementBaseV2();
 ...
 * @member {String} name
 */
AchievementBaseV2.prototype['name'] = undefined;

/**
 * The display name for the achievement in the Campaign Manager.
 * @member {String} title
 */
AchievementBaseV2.prototype['title'] = undefined;

/**
 * A description of the achievement.
 * @member {String} description
 */
AchievementBaseV2.prototype['description'] = undefined;

/**
 * The required number of actions or the transactional milestone to complete the achievement.
 * @member {Number} target
 */
AchievementBaseV2.prototype['target'] = undefined;
 ...
 */
AchievementBaseV2.prototype['period'] = undefined;
 ...
 * @member {module:model/AchievementBaseV2.RecurrencePolicyEnum} recurrencePolicy
 */
AchievementBaseV2.prototype['recurrencePolicy'] = undefined;
 ...
 * @member {module:model/AchievementBaseV2.ActivationPolicyEnum} activationPolicy
 */
AchievementBaseV2.prototype['activationPolicy'] = undefined;
 ...
 */
AchievementBaseV2.prototype['fixedStartDate'] = undefined;
 ...
 * @member {Date} endDate
 */
AchievementBaseV2.prototype['endDate'] = undefined;
 ...
 * @readonly
 */
AchievementBaseV2['RecurrencePolicyEnum'] = {
 ...
 * @readonly
 */
AchievementBaseV2['ActivationPolicyEnum'] = {
...
export default AchievementBaseV2;
