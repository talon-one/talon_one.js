...
class LedgerPointsEntryIntegrationAPI {
    /**
     * Constructs a new <code>LedgerPointsEntryIntegrationAPI</code>.
    ...
    /**
     * Constructs a <code>LedgerPointsEntryIntegrationAPI</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LedgerPointsEntryIntegrationAPI} obj Optional instance to populate.
     * @return {module:model/LedgerPointsEntryIntegrationAPI} The populated <code>LedgerPointsEntryIntegrationAPI</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LedgerPointsEntryIntegrationAPI();
 ...
 * @member {Date} created
 */
LedgerPointsEntryIntegrationAPI.prototype['created'] = undefined;

/**
 * ID of the loyalty program.
 * @member {Number} programId
 */
LedgerPointsEntryIntegrationAPI.prototype['programId'] = undefined;

/**
 * ID of the customer session where points were added.
 * @member {String} customerSessionId
 */
LedgerPointsEntryIntegrationAPI.prototype['customerSessionId'] = undefined;

/**
 * Name or reason of the transaction that adds loyalty points.
 * @member {String} name
 */
LedgerPointsEntryIntegrationAPI.prototype['name'] = undefined;
 ...
 */
LedgerPointsEntryIntegrationAPI.prototype['startDate'] = undefined;
 ...
 */
LedgerPointsEntryIntegrationAPI.prototype['expiryDate'] = undefined;

/**
 * ID of the subledger.
 * @member {String} subledgerId
 */
LedgerPointsEntryIntegrationAPI.prototype['subledgerId'] = undefined;

/**
 * Amount of loyalty points added in the transaction.
 * @member {Number} amount
 */
LedgerPointsEntryIntegrationAPI.prototype['amount'] = undefined;
 ...
 */
LedgerPointsEntryIntegrationAPI.prototype['validityDuration'] = undefined;
...
export default LedgerPointsEntryIntegrationAPI;
