...
class ExtendedCoupon {
    /**
     * Constructs a new <code>ExtendedCoupon</code>.
     * @alias module:model/ExtendedCoupon
     ...
     */
    constructor(id, created, campaignId, value, usageLimit, usageCounter, applicationId) { 
        
        ExtendedCoupon.initialize(this, id, created, campaignId, value, usageLimit, usageCounter, applicationId);
    }
     ...
     */
    static initialize(obj, id, created, campaignId, value, usageLimit, usageCounter, applicationId) { 
        obj['id'] = id;
        obj['created'] = created;
    ...
    /**
     * Constructs a <code>ExtendedCoupon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtendedCoupon} obj Optional instance to populate.
     * @return {module:model/ExtendedCoupon} The populated <code>ExtendedCoupon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtendedCoupon();
 ...
 * @member {Number} id
 */
ExtendedCoupon.prototype['id'] = undefined;

/**
 * The time the coupon was created.
 * @member {Date} created
 */
ExtendedCoupon.prototype['created'] = undefined;

/**
 * The ID of the campaign that owns this entity.
 * @member {Number} campaignId
 */
ExtendedCoupon.prototype['campaignId'] = undefined;

/**
 * The coupon code.
 * @member {String} value
 */
ExtendedCoupon.prototype['value'] = undefined;

/**
 * The number of times the coupon code can be redeemed. `0` means unlimited redemptions but any campaign usage limits will still apply. 
 * @member {Number} usageLimit
 */
ExtendedCoupon.prototype['usageLimit'] = undefined;

/**
 * The total discount value that the code can give. Typically used to represent a gift card value. 
 * @member {Number} discountLimit
 */
ExtendedCoupon.prototype['discountLimit'] = undefined;

/**
 * The number of reservations that can be made with this coupon code. 
 * @member {Number} reservationLimit
 */
ExtendedCoupon.prototype['reservationLimit'] = undefined;

/**
 * Timestamp at which point the coupon becomes valid.
 * @member {Date} startDate
 */
ExtendedCoupon.prototype['startDate'] = undefined;

/**
 * Expiration date of the coupon. Coupon never expires if this is omitted.
 * @member {Date} expiryDate
 */
ExtendedCoupon.prototype['expiryDate'] = undefined;
 ...
 */
ExtendedCoupon.prototype['limits'] = undefined;

/**
 * The number of times the coupon has been successfully redeemed.
 * @member {Number} usageCounter
 */
ExtendedCoupon.prototype['usageCounter'] = undefined;
 ...
 * @default true
 */
ExtendedCoupon.prototype['reservation'] = true;

/**
 * The id of the batch the coupon belongs to.
 * @member {String} batchId
 */
ExtendedCoupon.prototype['batchId'] = undefined;
 ...
 * @default false
 */
ExtendedCoupon.prototype['isReservationMandatory'] = false;

/**
 * An indication of whether the coupon is implicitly reserved for all customers.
 * @member {Boolean} implicitlyReserved
 */
ExtendedCoupon.prototype['implicitlyReserved'] = undefined;

/**
 * The ID of the application.
 * @member {Number} ApplicationId
 */
ExtendedCoupon.prototype['ApplicationId'] = undefined;
