...
import CustomerProfileAudienceRequestItem from './CustomerProfileAudienceRequestItem';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [CustomerProfileAudienceRequestItem]);
            }
        }
        return obj;
    }
