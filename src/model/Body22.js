...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.Body22 = factory(root.TalononeApi.ApiClient);
  }
   ...
   * @param mimeType {module:model/Body22.MimeTypeEnum} This defines how the request payload will be parsed before your handler code is run.
   ...
   * @member {module:model/Body22.MimeTypeEnum} mimeType
   */
   ...
   * @member {module:model/Body22.HandlerLanguageEnum} handlerLanguage
   */
