...
class LedgerTransactionLogEntryIntegrationAPI {
     ...
     * @param type {module:model/LedgerTransactionLogEntryIntegrationAPI.TypeEnum} Type of transaction. Possible values are:   - `addition`: Points were added.   - `subtraction`: Points were subtracted. 
     ...
     */
    constructor(created, programId, customerSessionId, type, name, startDate, expiryDate, subledgerId, amount, id) { 
        
        LedgerTransactionLogEntryIntegrationAPI.initialize(this, created, programId, customerSessionId, type, name, startDate, expiryDate, subledgerId, amount, id);
    }
     ...
     */
    static initialize(obj, created, programId, customerSessionId, type, name, startDate, expiryDate, subledgerId, amount, id) { 
        obj['created'] = created;
