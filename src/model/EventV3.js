...
/**
 * The EventV3 model module.
 * @module model/EventV3
 * @version 25.17.0
 */
class EventV3 {
    /**
     * Constructs a new <code>EventV3</code>.
     * @alias module:model/EventV3
    ...
    constructor(profileId, integrationId, type) { 
        ...
        EventV3.initialize(this, profileId, integrationId, type);
    }
    ...
    /**
     * Constructs a <code>EventV3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventV3} obj Optional instance to populate.
     * @return {module:model/EventV3} The populated <code>EventV3</code> instance.
     */
 ...
 */
EventV3.prototype['profileId'] = undefined;

/**
 * The integration ID of the store. You choose this ID when you create a store.
 * @member {String} storeIntegrationId
 */
EventV3.prototype['storeIntegrationId'] = undefined;
 ...
 * @member {String} type
 */
EventV3.prototype['type'] = undefined;
