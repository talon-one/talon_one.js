...
class CreateAchievementV2 {
    /**
     * Constructs a new <code>CreateAchievementV2</code>.
     * @alias module:model/CreateAchievementV2
     ...
     */
    constructor(name, title, description, target, sandbox, timezone) { 
        
        CreateAchievementV2.initialize(this, name, title, description, target, sandbox, timezone);
    }
     ...
     */
    static initialize(obj, name, title, description, target, sandbox, timezone) { 
        obj['name'] = name;
        obj['title'] = title;
    ...
    /**
     * Constructs a <code>CreateAchievementV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAchievementV2} obj Optional instance to populate.
     * @return {module:model/CreateAchievementV2} The populated <code>CreateAchievementV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAchievementV2();
 ...
 * @member {String} name
 */
CreateAchievementV2.prototype['name'] = undefined;

/**
 * The display name for the achievement in the Campaign Manager.
 * @member {String} title
 */
CreateAchievementV2.prototype['title'] = undefined;

/**
 * A description of the achievement.
 * @member {String} description
 */
CreateAchievementV2.prototype['description'] = undefined;

/**
 * The required number of actions or the transactional milestone to complete the achievement.
 * @member {Number} target
 */
CreateAchievementV2.prototype['target'] = undefined;
 ...
 */
CreateAchievementV2.prototype['period'] = undefined;
 ...
 * @member {module:model/CreateAchievementV2.RecurrencePolicyEnum} recurrencePolicy
 */
CreateAchievementV2.prototype['recurrencePolicy'] = undefined;
 ...
 * @member {module:model/CreateAchievementV2.ActivationPolicyEnum} activationPolicy
 */
CreateAchievementV2.prototype['activationPolicy'] = undefined;
 ...
 */
CreateAchievementV2.prototype['fixedStartDate'] = undefined;
 ...
 * @member {Date} endDate
 */
CreateAchievementV2.prototype['endDate'] = undefined;
 ...
 */
CreateAchievementV2.prototype['timezone'] = undefined;
 ...
 * @readonly
 */
CreateAchievementV2['RecurrencePolicyEnum'] = {
 ...
 * @readonly
 */
CreateAchievementV2['ActivationPolicyEnum'] = {
...
export default CreateAchievementV2;
