...
class NewWebhook {
     ...
     */
    constructor(applicationIds, title, draft, verb, url, headers, params, enabled) { 
        
        NewWebhook.initialize(this, applicationIds, title, draft, verb, url, headers, params, enabled);
    }
     ...
     */
    static initialize(obj, applicationIds, title, draft, verb, url, headers, params, enabled) { 
 ...
 */
NewWebhook.prototype['description'] = undefined;

/**
 * Indicates if the webhook is a draft.
 * @member {Boolean} draft
 */
NewWebhook.prototype['draft'] = undefined;
 ...
 */
NewWebhook.prototype['authenticationId'] = undefined;
