...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.ApiKeyWithUsage = factory(root.TalononeApi.ApiClient);
  }
  ...
  /**
   * The ApiKeyWithUsage model module.
   * @module model/ApiKeyWithUsage
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ApiKeyWithUsage</code>.
   * 
   * @alias module:model/ApiKeyWithUsage
   * @class
  ...
  /**
   * Constructs a <code>ApiKeyWithUsage</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ApiKeyWithUsage} obj Optional instance to populate.
   * @return {module:model/ApiKeyWithUsage} The populated <code>ApiKeyWithUsage</code> instance.
   */
