...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.InlineResponse20018CartItems = factory(root.TalononeApi.ApiClient, root.TalononeApi.InlineResponse20018Adjustment);
  }
  ...
  /**
   * The InlineResponse20018CartItems model module.
   * @module model/InlineResponse20018CartItems
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20018CartItems</code>.
   * @alias module:model/InlineResponse20018CartItems
   * @class
   * @param name {String} 
   * @param sku {String} 
  ...
  /**
   * Constructs a <code>InlineResponse20018CartItems</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20018CartItems} obj Optional instance to populate.
   * @return {module:model/InlineResponse20018CartItems} The populated <code>InlineResponse20018CartItems</code> instance.
   */
