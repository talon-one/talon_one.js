...
/**
 * The CouponWithApplication model module.
 * @module model/CouponWithApplication
 * @version 25.17.0
 */
class CouponWithApplication {
    /**
     * Constructs a new <code>CouponWithApplication</code>.
     * @alias module:model/CouponWithApplication
     ...
     * @param applicationName {String} Name of the Application that is connected to the coupon.
     */
    constructor(id, created, campaignId, value, usageLimit, usageCounter, applicationId, applicationName) { 
        
        CouponWithApplication.initialize(this, id, created, campaignId, value, usageLimit, usageCounter, applicationId, applicationName);
    }
     ...
     */
    static initialize(obj, id, created, campaignId, value, usageLimit, usageCounter, applicationId, applicationName) { 
        obj['id'] = id;
        obj['created'] = created;
    ...
    /**
     * Constructs a <code>CouponWithApplication</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CouponWithApplication} obj Optional instance to populate.
     * @return {module:model/CouponWithApplication} The populated <code>CouponWithApplication</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CouponWithApplication();
 ...
 * @member {Number} id
 */
CouponWithApplication.prototype['id'] = undefined;

/**
 * The time the coupon was created.
 * @member {Date} created
 */
CouponWithApplication.prototype['created'] = undefined;

/**
 * The ID of the campaign that owns this entity.
 * @member {Number} campaignId
 */
CouponWithApplication.prototype['campaignId'] = undefined;

/**
 * The coupon code.
 * @member {String} value
 */
CouponWithApplication.prototype['value'] = undefined;

/**
 * The number of times the coupon code can be redeemed. `0` means unlimited redemptions but any campaign usage limits will still apply. 
 * @member {Number} usageLimit
 */
CouponWithApplication.prototype['usageLimit'] = undefined;

/**
 * The total discount value that the code can give. Typically used to represent a gift card value. 
 * @member {Number} discountLimit
 */
CouponWithApplication.prototype['discountLimit'] = undefined;

/**
 * The number of reservations that can be made with this coupon code. 
 * @member {Number} reservationLimit
 */
CouponWithApplication.prototype['reservationLimit'] = undefined;

/**
 * Timestamp at which point the coupon becomes valid.
 * @member {Date} startDate
 */
CouponWithApplication.prototype['startDate'] = undefined;

/**
 * Expiration date of the coupon. Coupon never expires if this is omitted.
 * @member {Date} expiryDate
 */
CouponWithApplication.prototype['expiryDate'] = undefined;
 ...
 */
CouponWithApplication.prototype['limits'] = undefined;

/**
 * The number of times the coupon has been successfully redeemed.
 * @member {Number} usageCounter
 */
CouponWithApplication.prototype['usageCounter'] = undefined;
 ...
 */
CouponWithApplication.prototype['discountCounter'] = undefined;

/**
 * The remaining discount this coupon can give.
 * @member {Number} discountRemainder
 */
CouponWithApplication.prototype['discountRemainder'] = undefined;

/**
 * The number of times this coupon has been reserved.
 * @member {Number} reservationCounter
 */
CouponWithApplication.prototype['reservationCounter'] = undefined;

/**
 * Custom attributes associated with this coupon.
 * @member {Object} attributes
 */
CouponWithApplication.prototype['attributes'] = undefined;
 ...
 * @default true
 */
CouponWithApplication.prototype['reservation'] = true;

/**
 * The id of the batch the coupon belongs to.
 * @member {String} batchId
 */
CouponWithApplication.prototype['batchId'] = undefined;
 ...
 * @default false
 */
CouponWithApplication.prototype['isReservationMandatory'] = false;

/**
 * An indication of whether the coupon is implicitly reserved for all customers.
 * @member {Boolean} implicitlyReserved
 */
CouponWithApplication.prototype['implicitlyReserved'] = undefined;

/**
 * The ID of the application.
 * @member {Number} applicationId
 */
CouponWithApplication.prototype['applicationId'] = undefined;

/**
 * Name of the Application that is connected to the coupon.
 * @member {String} applicationName
 */
CouponWithApplication.prototype['applicationName'] = undefined;
...
export default CouponWithApplication;
