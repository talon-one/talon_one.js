...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.InlineResponse20026Data = factory(root.TalononeApi.ApiClient);
  }
   ...
   * @param mimeType {module:model/InlineResponse20026Data.MimeTypeEnum} This defines how the request payload will be parsed before your handler code is run.
   ...
   */
  var exports = function(id, created, applicationIds, title, name, description, mimeType, handler, version) {
    var _this = this;
   ...
   * @member {module:model/InlineResponse20026Data.MimeTypeEnum} mimeType
   */
   ...
   * @member {module:model/InlineResponse20026Data.HandlerLanguageEnum} handlerLanguage
   */
