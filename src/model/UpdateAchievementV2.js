...
class UpdateAchievementV2 {
    ...
    /**
     * Constructs a <code>UpdateAchievementV2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAchievementV2} obj Optional instance to populate.
     * @return {module:model/UpdateAchievementV2} The populated <code>UpdateAchievementV2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAchievementV2();
 ...
 * @member {String} name
 */
UpdateAchievementV2.prototype['name'] = undefined;

/**
 * The display name for the achievement in the Campaign Manager.
 * @member {String} title
 */
UpdateAchievementV2.prototype['title'] = undefined;

/**
 * A description of the achievement.
 * @member {String} description
 */
UpdateAchievementV2.prototype['description'] = undefined;

/**
 * The required number of actions or the transactional milestone to complete the achievement.
 * @member {Number} target
 */
UpdateAchievementV2.prototype['target'] = undefined;
 ...
 */
UpdateAchievementV2.prototype['period'] = undefined;
 ...
 * @member {module:model/UpdateAchievementV2.RecurrencePolicyEnum} recurrencePolicy
 */
UpdateAchievementV2.prototype['recurrencePolicy'] = undefined;
 ...
 * @member {module:model/UpdateAchievementV2.ActivationPolicyEnum} activationPolicy
 */
UpdateAchievementV2.prototype['activationPolicy'] = undefined;
 ...
 */
UpdateAchievementV2.prototype['fixedStartDate'] = undefined;
 ...
 * @member {Date} endDate
 */
UpdateAchievementV2.prototype['endDate'] = undefined;
 ...
 * @readonly
 */
UpdateAchievementV2['RecurrencePolicyEnum'] = {
 ...
 * @readonly
 */
UpdateAchievementV2['ActivationPolicyEnum'] = {
...
export default UpdateAchievementV2;
