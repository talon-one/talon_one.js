...
class CampaignEditedNotification {
     ...
     * @param notificationType {module:model/CampaignEditedNotification.NotificationTypeEnum} The type of the notification
     * @param totalResultSize {Number} The total size of the result set.
     */
    constructor(notificationType, totalResultSize) { 
        
        CampaignEditedNotification.initialize(this, notificationType, totalResultSize);
    }
 ...
 * @member {module:model/CampaignEditedNotification.NotificationTypeEnum} NotificationType
 */
 ...
 * @readonly
 */
CampaignEditedNotification['NotificationTypeEnum'] = {
