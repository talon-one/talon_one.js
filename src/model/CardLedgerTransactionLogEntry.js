...
class CardLedgerTransactionLogEntry {
     ...
     * @param type {module:model/CardLedgerTransactionLogEntry.TypeEnum} Type of transaction. Possible values are:   - `addition`: Points were added.   - `subtraction`: Points were subtracted. 
    ...
    constructor(created, programId, cardIdentifier, customerSessionId, type, name, startDate, expiryDate, subledgerId, amount, id) { 
        ...
        CardLedgerTransactionLogEntry.initialize(this, created, programId, cardIdentifier, customerSessionId, type, name, startDate, expiryDate, subledgerId, amount, id);
    }
