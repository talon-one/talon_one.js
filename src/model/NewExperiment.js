...
class NewExperiment {
    /**
     * Constructs a new <code>NewExperiment</code>.
    ...
    /**
     * Constructs a <code>NewExperiment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewExperiment} obj Optional instance to populate.
     * @return {module:model/NewExperiment} The populated <code>NewExperiment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewExperiment();
 ...
 */
NewExperiment.prototype['isVariantAssignmentExternal'] = undefined;

/**
 * @member {module:model/NewCampaign} campaign
 */
