...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.Body2 = factory(root.TalononeApi.ApiClient, root.TalononeApi.InlineResponse2001CouponSettings, root.TalononeApi.InlineResponse2001Limits);
  }
   ...
   * @param state {module:model/Body2.StateEnum} A disabled or archived campaign is not evaluated for rules or coupons. 
   * @param tags {Array.<String>} A list of tags for the campaign.
   * @param features {Array.<module:model/Body2.FeaturesEnum>} A list of features for the campaign.
   ...
   * @member {Array.<module:model/Body2.FeaturesEnum>} features
   */
