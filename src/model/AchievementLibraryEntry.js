...
/**
 * The AchievementLibraryEntry model module.
 * @module model/AchievementLibraryEntry
 * @version 11.0.0
 */
class AchievementLibraryEntry {
    /**
     * Constructs a new <code>AchievementLibraryEntry</code>.
     * @alias module:model/AchievementLibraryEntry
     ...
     */
    constructor(id, created, name, title, description, target) { 
        
        AchievementLibraryEntry.initialize(this, id, created, name, title, description, target);
    }
     ...
     */
    static initialize(obj, id, created, name, title, description, target) { 
        obj['id'] = id;
        obj['created'] = created;
        obj['name'] = name;
        obj['title'] = title;
    ...
    /**
     * Constructs a <code>AchievementLibraryEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AchievementLibraryEntry} obj Optional instance to populate.
     * @return {module:model/AchievementLibraryEntry} The populated <code>AchievementLibraryEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AchievementLibraryEntry();
            ...
            if (data.hasOwnProperty('currentProgress')) {
                obj['currentProgress'] = AchievementProgress.constructFromObject(data['currentProgress']);
            }
        }
        return obj;
    }
 ...
 * @member {Number} id
 */
AchievementLibraryEntry.prototype['id'] = undefined;

/**
 * The time this entity was created.
 * @member {Date} created
 */
AchievementLibraryEntry.prototype['created'] = undefined;
 ...
 * @member {String} name
 */
AchievementLibraryEntry.prototype['name'] = undefined;

/**
 * The display name for the achievement in the Campaign Manager.
 * @member {String} title
 */
AchievementLibraryEntry.prototype['title'] = undefined;

/**
 * A description of the achievement.
 * @member {String} description
 */
AchievementLibraryEntry.prototype['description'] = undefined;

/**
 * The required number of actions or the transactional milestone to complete the achievement.
 * @member {Number} target
 */
AchievementLibraryEntry.prototype['target'] = undefined;
 ...
 */
AchievementLibraryEntry.prototype['period'] = undefined;

/**
 * @member {module:model/TimePoint} periodEndOverride
 */
AchievementLibraryEntry.prototype['periodEndOverride'] = undefined;
 ...
 * @member {module:model/AchievementLibraryEntry.RecurrencePolicyEnum} recurrencePolicy
 */
AchievementLibraryEntry.prototype['recurrencePolicy'] = undefined;
 ...
 * @member {module:model/AchievementLibraryEntry.ActivationPolicyEnum} activationPolicy
 */
AchievementLibraryEntry.prototype['activationPolicy'] = undefined;
 ...
 */
AchievementLibraryEntry.prototype['fixedStartDate'] = undefined;
 ...
 * @member {Date} endDate
 */
AchievementLibraryEntry.prototype['endDate'] = undefined;

/**
 * When `true`, it prevents the achievement from exceeding the target.
 * @member {Boolean} isCappedByTarget
 */
AchievementLibraryEntry.prototype['isCappedByTarget'] = undefined;

/**
 * When `true`, a customer can join an achievement only after explicit opt-in.
 * @member {Boolean} isOptinRequired
 */
AchievementLibraryEntry.prototype['isOptinRequired'] = undefined;

/**
 * @member {module:model/AchievementProgress} currentProgress
 */
AchievementLibraryEntry.prototype['currentProgress'] = undefined;
 ...
 * @readonly
 */
AchievementLibraryEntry['RecurrencePolicyEnum'] = {
 ...
 * @readonly
 */
AchievementLibraryEntry['ActivationPolicyEnum'] = {
...
export default AchievementLibraryEntry;
