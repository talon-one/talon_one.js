...
class CampaignNotificationGeneric {
     ...
     */
    constructor(notificationType, totalResultSize, data) { 
        
        CampaignNotificationGeneric.initialize(this, notificationType, totalResultSize, data);
    }
     ...
     */
    static initialize(obj, notificationType, totalResultSize, data) { 
