...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20028Data'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20028Data'));
  } else {
    // Browser globals (root is window)
    if (!root.TalononeApi) {
      root.TalononeApi = {};
    }
    root.TalononeApi.InlineResponse20028 = factory(root.TalononeApi.ApiClient, root.TalononeApi.InlineResponse20028Data);
  }
}(this, function(ApiClient, InlineResponse20028Data) {
  'use strict';
   ...
   * @param data {Array.<module:model/InlineResponse20028Data>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [InlineResponse20028Data]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/InlineResponse20028Data>} data
   */
