...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.Body19 = factory(root.TalononeApi.ApiClient);
  }
   ...
   * @class
   * @param entity {module:model/Body19.EntityEnum} The name of the entity that can have this attribute. When creating or updating the entities of a given type, you can include an `attributes` object with keys corresponding to the `name` of the custom attributes for that type.
   ...
   * @param type {module:model/Body19.TypeEnum} The data type of the attribute, a `time` attribute must be sent as a string that conforms to the [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) timestamp format.
   ...
   * @member {module:model/Body19.EntityEnum} entity
   */
   ...
   * @member {module:model/Body19.TypeEnum} type
   */
