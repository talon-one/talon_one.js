...
class CampaignDeletedNotification {
     ...
     * @param notificationType {module:model/CampaignDeletedNotification.NotificationTypeEnum} The type of the notification
     * @param totalResultSize {Number} The total size of the result set.
     */
    constructor(notificationType, totalResultSize) { 
        
        CampaignDeletedNotification.initialize(this, notificationType, totalResultSize);
    }
 ...
 * @member {module:model/CampaignDeletedNotification.NotificationTypeEnum} NotificationType
 */
 ...
 * @readonly
 */
CampaignDeletedNotification['NotificationTypeEnum'] = {
