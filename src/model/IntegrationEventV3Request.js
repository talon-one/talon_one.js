...
class IntegrationEventV3Request {
    ...
    /**
     * Constructs a <code>IntegrationEventV3Request</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IntegrationEventV3Request} obj Optional instance to populate.
     * @return {module:model/IntegrationEventV3Request} The populated <code>IntegrationEventV3Request</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IntegrationEventV3Request();
 ...
 */
IntegrationEventV3Request.prototype['profileId'] = undefined;

/**
 * The integration ID of the store. You choose this ID when you create a store.
 * @member {String} storeIntegrationId
 */
IntegrationEventV3Request.prototype['storeIntegrationId'] = undefined;
 ...
 */
IntegrationEventV3Request.prototype['loyaltyCards'] = undefined;

/**
 * Optional list of requested information to be present on the response related to the tracking custom event. 
 * @member {Array.<module:model/IntegrationEventV3Request.ResponseContentEnum>} responseContent
 */
IntegrationEventV3Request.prototype['responseContent'] = undefined;
...
export default IntegrationEventV3Request;
