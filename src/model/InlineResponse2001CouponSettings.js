...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.InlineResponse2001CouponSettings = factory(root.TalononeApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse2001CouponSettings model module.
   * @module model/InlineResponse2001CouponSettings
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2001CouponSettings</code>.
   * @alias module:model/InlineResponse2001CouponSettings
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse2001CouponSettings</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2001CouponSettings} obj Optional instance to populate.
   * @return {module:model/InlineResponse2001CouponSettings} The populated <code>InlineResponse2001CouponSettings</code> instance.
   */
