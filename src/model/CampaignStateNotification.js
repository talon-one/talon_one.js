...
/**
 * The CampaignStateNotification model module.
 * @module model/CampaignStateNotification
 * @version 6.0.0
 */
class CampaignStateNotification {
    /**
     * Constructs a new <code>CampaignStateNotification</code>.
     * Campaign data and its state changes.
     * @alias module:model/CampaignStateNotification
     ...
     * @param state {module:model/CampaignStateNotification.StateEnum} A disabled or archived campaign is not evaluated for rules or coupons. 
     * @param tags {Array.<String>} A list of tags for the campaign.
     * @param features {Array.<module:model/CampaignStateNotification.FeaturesEnum>} The features enabled in this campaign.
     ...
     * @param type {module:model/CampaignStateNotification.TypeEnum} The campaign type. Possible type values:   - `cartItem`: Type of campaign that can apply effects only to cart items.   - `advanced`: Type of campaign that can apply effects to customer sessions and cart items. 
     ...
     * @param frontendState {module:model/CampaignStateNotification.FrontendStateEnum} A campaign state described exactly as in the Campaign Manager.
     */
    constructor(id, created, applicationId, userId, name, description, state, tags, features, limits, type, budgets, frontendState) { 
        
        CampaignStateNotification.initialize(this, id, created, applicationId, userId, name, description, state, tags, features, limits, type, budgets, frontendState);
    }
    ...
    /**
     * Constructs a <code>CampaignStateNotification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CampaignStateNotification} obj Optional instance to populate.
     * @return {module:model/CampaignStateNotification} The populated <code>CampaignStateNotification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CampaignStateNotification();
 ...
 * @member {Number} id
 */
CampaignStateNotification.prototype['id'] = undefined;

/**
 * The exact moment this entity was created.
 * @member {Date} created
 */
CampaignStateNotification.prototype['created'] = undefined;

/**
 * The ID of the application that owns this entity.
 * @member {Number} applicationId
 */
CampaignStateNotification.prototype['applicationId'] = undefined;

/**
 * The ID of the user associated with this entity.
 * @member {Number} userId
 */
CampaignStateNotification.prototype['userId'] = undefined;

/**
 * A user-facing name for this campaign.
 * @member {String} name
 */
CampaignStateNotification.prototype['name'] = undefined;

/**
 * A detailed description of the campaign.
 * @member {String} description
 */
CampaignStateNotification.prototype['description'] = undefined;

/**
 * Timestamp when the campaign will become active.
 * @member {Date} startTime
 */
CampaignStateNotification.prototype['startTime'] = undefined;

/**
 * Timestamp when the campaign will become inactive.
 * @member {Date} endTime
 */
CampaignStateNotification.prototype['endTime'] = undefined;

/**
 * Arbitrary properties associated with this campaign.
 * @member {Object} attributes
 */
CampaignStateNotification.prototype['attributes'] = undefined;

/**
 * A disabled or archived campaign is not evaluated for rules or coupons. 
 * @member {module:model/CampaignStateNotification.StateEnum} state
 * @default 'enabled'
 */
CampaignStateNotification.prototype['state'] = 'enabled';
 ...
 */
CampaignStateNotification.prototype['activeRulesetId'] = undefined;

/**
 * A list of tags for the campaign.
 * @member {Array.<String>} tags
 */
CampaignStateNotification.prototype['tags'] = undefined;

/**
 * The features enabled in this campaign.
 * @member {Array.<module:model/CampaignStateNotification.FeaturesEnum>} features
 */
CampaignStateNotification.prototype['features'] = undefined;

/**
 * @member {module:model/CodeGeneratorSettings} couponSettings
 */
CampaignStateNotification.prototype['couponSettings'] = undefined;

/**
 * @member {module:model/CodeGeneratorSettings} referralSettings
 */
CampaignStateNotification.prototype['referralSettings'] = undefined;
 ...
 */
CampaignStateNotification.prototype['limits'] = undefined;
 ...
 */
CampaignStateNotification.prototype['campaignGroups'] = undefined;

/**
 * The ID of the campaign evaluation group the campaign belongs to.
 * @member {Number} evaluationGroupId
 */
CampaignStateNotification.prototype['evaluationGroupId'] = undefined;
 ...
 * @member {module:model/CampaignStateNotification.TypeEnum} type
 * @default 'advanced'
 */
CampaignStateNotification.prototype['type'] = 'advanced';
 ...
 */
CampaignStateNotification.prototype['linkedStoreIds'] = undefined;
 ...
 */
CampaignStateNotification.prototype['budgets'] = undefined;
 ...
 */
CampaignStateNotification.prototype['couponRedemptionCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['referralRedemptionCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['discountCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['discountEffectCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['couponCreationCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['customEffectCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['referralCreationCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['addFreeItemEffectCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['awardedGiveawaysCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['createdLoyaltyPointsCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['createdLoyaltyPointsEffectCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['redeemedLoyaltyPointsCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['redeemedLoyaltyPointsEffectCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['callApiEffectCount'] = undefined;
 ...
 */
CampaignStateNotification.prototype['reservecouponEffectCount'] = undefined;

/**
 * Timestamp of the most recent event received by this campaign.
 * @member {Date} lastActivity
 */
CampaignStateNotification.prototype['lastActivity'] = undefined;
 ...
 * @member {Date} updated
 */
CampaignStateNotification.prototype['updated'] = undefined;

/**
 * Name of the user who created this campaign if available.
 * @member {String} createdBy
 */
CampaignStateNotification.prototype['createdBy'] = undefined;

/**
 * Name of the user who last updated this campaign if available.
 * @member {String} updatedBy
 */
CampaignStateNotification.prototype['updatedBy'] = undefined;

/**
 * The ID of the Campaign Template this Campaign was created from.
 * @member {Number} templateId
 */
CampaignStateNotification.prototype['templateId'] = undefined;

/**
 * A campaign state described exactly as in the Campaign Manager.
 * @member {module:model/CampaignStateNotification.FrontendStateEnum} frontendState
 */
CampaignStateNotification.prototype['frontendState'] = undefined;
 ...
 * @readonly
 */
CampaignStateNotification['StateEnum'] = {
 ...
 * @readonly
 */
CampaignStateNotification['FeaturesEnum'] = {
 ...
 * @readonly
 */
CampaignStateNotification['TypeEnum'] = {
 ...
 * @readonly
 */
CampaignStateNotification['FrontendStateEnum'] = {
...
export default CampaignStateNotification;
