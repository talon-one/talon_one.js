...
class GenerateCampaignTags {
    ...
    /**
     * Constructs a <code>GenerateCampaignTags</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateCampaignTags} obj Optional instance to populate.
     * @return {module:model/GenerateCampaignTags} The populated <code>GenerateCampaignTags</code> instance.
     */
...
export default GenerateCampaignTags;
