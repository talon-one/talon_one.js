...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TalononeApi.InlineResponse20018Adjustment = factory(root.TalononeApi.ApiClient);
  }
  ...
  /**
   * The InlineResponse20018Adjustment model module.
   * @module model/InlineResponse20018Adjustment
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20018Adjustment</code>.
   * @alias module:model/InlineResponse20018Adjustment
   * @class
  ...
  /**
   * Constructs a <code>InlineResponse20018Adjustment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20018Adjustment} obj Optional instance to populate.
   * @return {module:model/InlineResponse20018Adjustment} The populated <code>InlineResponse20018Adjustment</code> instance.
   */
