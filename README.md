...
const loginParams = new TalonOne.LoginParams('admin@talon.one', '$hhhD0ntT3ll!')
...
managerApi.createSession(loginParams).then(function(data) {
  ...
  managerApi.getApplication(7).then(function(data) {
...
//api_key_v1.apiKeyPrefix['Authorization'] = "Token"
...
var api = new TalonOne.IntegrationApi()
...
api.createCouponReservation(couponValue, body).then(function(data) {
