...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationEventV2Request();
  });
  ...
  describe('IntegrationEventV2Request', function() {
    it('should create an instance of IntegrationEventV2Request', function() {
      // uncomment below and update the code to test IntegrationEventV2Request
      //var instane = new TalonOne.IntegrationEventV2Request();
      //expect(instance).to.be.a(TalonOne.IntegrationEventV2Request);
    });
