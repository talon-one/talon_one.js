...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignGroup();
  });
  ...
  describe('CampaignGroup', function() {
    it('should create an instance of CampaignGroup', function() {
      // uncomment below and update the code to test CampaignGroup
