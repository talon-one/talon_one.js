...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ExtendedCoupon();
  });
  ...
  describe('ExtendedCoupon', function() {
    it('should create an instance of ExtendedCoupon', function() {
      // uncomment below and update the code to test ExtendedCoupon
      //var instane = new TalonOne.ExtendedCoupon();
      //expect(instance).to.be.a(TalonOne.ExtendedCoupon);
    });
