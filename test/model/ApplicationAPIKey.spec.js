...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ApplicationAPIKey();
  });
  ...
  describe('ApplicationAPIKey', function() {
    it('should create an instance of ApplicationAPIKey', function() {
      // uncomment below and update the code to test ApplicationAPIKey
      //var instance = new TalonOne.ApplicationAPIKey();
