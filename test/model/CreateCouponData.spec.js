...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CreateCouponData();
  });
  ...
  describe('CreateCouponData', function() {
    it('should create an instance of CreateCouponData', function() {
      // uncomment below and update the code to test CreateCouponData
      //var instane = new TalonOne.CreateCouponData();
      //expect(instance).to.be.a(TalonOne.CreateCouponData);
    });
