...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.TrackEventV2Response();
  });
  ...
  describe('TrackEventV2Response', function() {
    it('should create an instance of TrackEventV2Response', function() {
      // uncomment below and update the code to test TrackEventV2Response
      //var instane = new TalonOne.TrackEventV2Response();
      //expect(instance).to.be.a(TalonOne.TrackEventV2Response);
    });
