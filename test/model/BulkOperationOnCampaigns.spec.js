...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.BulkOperationOnCampaigns();
  });
  ...
  describe('BulkOperationOnCampaigns', function() {
    it('should create an instance of BulkOperationOnCampaigns', function() {
      // uncomment below and update the code to test BulkOperationOnCampaigns
      //var instane = new TalonOne.BulkOperationOnCampaigns();
      //expect(instance).to.be.a(TalonOne.BulkOperationOnCampaigns);
    });
