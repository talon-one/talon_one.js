...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.LibraryAttribute();
  });
  ...
  describe('LibraryAttribute', function() {
    it('should create an instance of LibraryAttribute', function() {
      // uncomment below and update the code to test LibraryAttribute
      //var instane = new TalononeApi.LibraryAttribute();
      //expect(instance).to.be.a(TalononeApi.LibraryAttribute);
    });
