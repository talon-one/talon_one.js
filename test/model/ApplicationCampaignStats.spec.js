...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ApplicationCampaignStats();
  });
  ...
  describe('ApplicationCampaignStats', function() {
    it('should create an instance of ApplicationCampaignStats', function() {
      // uncomment below and update the code to test ApplicationCampaignStats
