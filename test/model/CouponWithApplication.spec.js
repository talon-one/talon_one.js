...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CouponWithApplication();
  });
  ...
  describe('CouponWithApplication', function() {
    it('should create an instance of CouponWithApplication', function() {
      // uncomment below and update the code to test CouponWithApplication
      //var instane = new TalonOne.CouponWithApplication();
      //expect(instance).to.be.a(TalonOne.CouponWithApplication);
    });
