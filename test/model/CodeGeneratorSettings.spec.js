...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CodeGeneratorSettings();
  });
  ...
  describe('CodeGeneratorSettings', function() {
    it('should create an instance of CodeGeneratorSettings', function() {
      // uncomment below and update the code to test CodeGeneratorSettings
      //var instane = new TalononeApi.CodeGeneratorSettings();
      //expect(instance).to.be.a(TalononeApi.CodeGeneratorSettings);
    });
