...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationHubFlowResponse();
  });
  ...
  describe('IntegrationHubFlowResponse', function() {
    it('should create an instance of IntegrationHubFlowResponse', function() {
      // uncomment below and update the code to test IntegrationHubFlowResponse
