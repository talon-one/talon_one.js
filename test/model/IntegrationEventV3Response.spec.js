...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationEventV3Response();
  });
  ...
  describe('IntegrationEventV3Response', function() {
    it('should create an instance of IntegrationEventV3Response', function() {
      // uncomment below and update the code to test IntegrationEventV3Response
      //var instane = new TalonOne.IntegrationEventV3Response();
      //expect(instance).to.be.a(TalonOne.IntegrationEventV3Response);
    });
