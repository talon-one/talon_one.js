...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewLoyaltyProgram();
  });
  ...
  describe('NewLoyaltyProgram', function() {
    it('should create an instance of NewLoyaltyProgram', function() {
      // uncomment below and update the code to test NewLoyaltyProgram
      //var instane = new TalonOne.NewLoyaltyProgram();
      //expect(instance).to.be.a(TalonOne.NewLoyaltyProgram);
    });
