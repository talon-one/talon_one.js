...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AchievementProgress();
  });
  ...
  describe('AchievementProgress', function() {
    it('should create an instance of AchievementProgress', function() {
      // uncomment below and update the code to test AchievementProgress
