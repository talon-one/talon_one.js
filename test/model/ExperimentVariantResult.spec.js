...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ExperimentVariantResult();
  });
  ...
  describe('ExperimentVariantResult', function() {
    it('should create an instance of ExperimentVariantResult', function() {
      // uncomment below and update the code to test ExperimentVariantResult
      //var instane = new TalonOne.ExperimentVariantResult();
      //expect(instance).to.be.a(TalonOne.ExperimentVariantResult);
    });
    ...
    it('should have the property variantWeight (base name: "variantWeight")', function() {
      // uncomment below and update the code to test the property variantWeight
      //var instane = new TalonOne.ExperimentVariantResult();
      //expect(instance).to.be();
    });

    it('should have the property isWinner (base name: "isWinner")', function() {
      // uncomment below and update the code to test the property isWinner
      //var instane = new TalonOne.ExperimentVariantResult();
      //expect(instance).to.be();
    });
    ...
    it('should have the property avgDiscountedSessionValue (base name: "avgDiscountedSessionValue")', function() {
      // uncomment below and update the code to test the property avgDiscountedSessionValue
      //var instane = new TalonOne.ExperimentVariantResult();
      //expect(instance).to.be();
    });
