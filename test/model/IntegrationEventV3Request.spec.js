...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationEventV3Request();
  });
  ...
  describe('IntegrationEventV3Request', function() {
    it('should create an instance of IntegrationEventV3Request', function() {
      // uncomment below and update the code to test IntegrationEventV3Request
      //var instane = new TalonOne.IntegrationEventV3Request();
      //expect(instance).to.be.a(TalonOne.IntegrationEventV3Request);
    });
