...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.UpdateCollection();
  });
  ...
  describe('UpdateCollection', function() {
    it('should create an instance of UpdateCollection', function() {
      // uncomment below and update the code to test UpdateCollection
      //var instane = new TalonOne.UpdateCollection();
      //expect(instance).to.be.a(TalonOne.UpdateCollection);
    });
