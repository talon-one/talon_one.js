...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.LoyaltyMembership();
  });
  ...
  describe('LoyaltyMembership', function() {
    it('should create an instance of LoyaltyMembership', function() {
      // uncomment below and update the code to test LoyaltyMembership
      //var instane = new TalononeApi.LoyaltyMembership();
      //expect(instance).to.be.a(TalononeApi.LoyaltyMembership);
    });
