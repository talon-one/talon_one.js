...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CardLedgerTransactionLogEntryIntegrationAPI();
  });
  ...
  describe('CardLedgerTransactionLogEntryIntegrationAPI', function() {
    it('should create an instance of CardLedgerTransactionLogEntryIntegrationAPI', function() {
      // uncomment below and update the code to test CardLedgerTransactionLogEntryIntegrationAPI
