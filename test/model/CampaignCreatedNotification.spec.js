...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignCreatedNotification();
  });
  ...
  describe('CampaignCreatedNotification', function() {
    it('should create an instance of CampaignCreatedNotification', function() {
      // uncomment below and update the code to test CampaignCreatedNotification
      //var instane = new TalonOne.CampaignCreatedNotification();
      //expect(instance).to.be.a(TalonOne.CampaignCreatedNotification);
    });
