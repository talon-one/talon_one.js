...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationHubFlow();
  });
  ...
  describe('IntegrationHubFlow', function() {
    it('should create an instance of IntegrationHubFlow', function() {
      // uncomment below and update the code to test IntegrationHubFlow
      //var instane = new TalonOne.IntegrationHubFlow();
      //expect(instance).to.be.a(TalonOne.IntegrationHubFlow);
    });
