...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.NewReferral();
  });
  ...
  describe('NewReferral', function() {
    it('should create an instance of NewReferral', function() {
      // uncomment below and update the code to test NewReferral
      //var instane = new TalononeApi.NewReferral();
      //expect(instance).to.be.a(TalononeApi.NewReferral);
    });
