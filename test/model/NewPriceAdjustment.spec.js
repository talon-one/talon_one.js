...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewPriceAdjustment();
  });
  ...
  describe('NewPriceAdjustment', function() {
    it('should create an instance of NewPriceAdjustment', function() {
      // uncomment below and update the code to test NewPriceAdjustment
      //var instane = new TalonOne.NewPriceAdjustment();
      //expect(instance).to.be.a(TalonOne.NewPriceAdjustment);
    });
    ...
    it('should have the property effectiveUntil (base name: "effectiveUntil")', function() {
      // uncomment below and update the code to test the property effectiveUntil
      //var instane = new TalonOne.NewPriceAdjustment();
      //expect(instance).to.be();
    });
