...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.Giveaway();
  });
  ...
  describe('Giveaway', function() {
    it('should create an instance of Giveaway', function() {
      // uncomment below and update the code to test Giveaway
      //var instane = new TalonOne.Giveaway();
      //expect(instance).to.be.a(TalonOne.Giveaway);
    });
