...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignCreatedNotificationItem();
  });
  ...
  describe('CampaignCreatedNotificationItem', function() {
    it('should create an instance of CampaignCreatedNotificationItem', function() {
      // uncomment below and update the code to test CampaignCreatedNotificationItem
      //var instane = new TalonOne.CampaignCreatedNotificationItem();
      //expect(instance).to.be.a(TalonOne.CampaignCreatedNotificationItem);
    });
