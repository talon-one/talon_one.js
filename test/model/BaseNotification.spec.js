...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.BaseNotification();
  });
  ...
  describe('BaseNotification', function() {
    it('should create an instance of BaseNotification', function() {
      // uncomment below and update the code to test BaseNotification
      //var instane = new TalonOne.BaseNotification();
      //expect(instance).to.be.a(TalonOne.BaseNotification);
    });
