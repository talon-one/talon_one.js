...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.DeductLoyaltyPoints();
  });
  ...
  describe('DeductLoyaltyPoints', function() {
    it('should create an instance of DeductLoyaltyPoints', function() {
      // uncomment below and update the code to test DeductLoyaltyPoints
      //var instane = new TalonOne.DeductLoyaltyPoints();
      //expect(instance).to.be.a(TalonOne.DeductLoyaltyPoints);
    });
