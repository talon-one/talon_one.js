...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.LoyaltyDashboardData();
  });
  ...
  describe('LoyaltyDashboardData', function() {
    it('should create an instance of LoyaltyDashboardData', function() {
      // uncomment below and update the code to test LoyaltyDashboardData
      //var instane = new TalonOne.LoyaltyDashboardData();
      //expect(instance).to.be.a(TalonOne.LoyaltyDashboardData);
    });
