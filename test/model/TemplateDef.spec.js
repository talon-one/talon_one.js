...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.TemplateDef();
  });
  ...
  describe('TemplateDef', function() {
    it('should create an instance of TemplateDef', function() {
      // uncomment below and update the code to test TemplateDef
      //var instane = new TalononeApi.TemplateDef();
      //expect(instance).to.be.a(TalononeApi.TemplateDef);
    });
