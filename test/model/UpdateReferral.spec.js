...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.UpdateReferral();
  });
  ...
  describe('UpdateReferral', function() {
    it('should create an instance of UpdateReferral', function() {
      // uncomment below and update the code to test UpdateReferral
      //var instane = new TalonOne.UpdateReferral();
      //expect(instance).to.be.a(TalonOne.UpdateReferral);
    });
