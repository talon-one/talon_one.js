...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.ApplicationCustomerSearch();
  });
  ...
  describe('ApplicationCustomerSearch', function() {
    it('should create an instance of ApplicationCustomerSearch', function() {
      // uncomment below and update the code to test ApplicationCustomerSearch
      //var instane = new TalononeApi.ApplicationCustomerSearch();
      //expect(instance).to.be.a(TalononeApi.ApplicationCustomerSearch);
    });
