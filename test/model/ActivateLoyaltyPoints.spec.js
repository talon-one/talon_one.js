...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ActivateLoyaltyPoints();
  });
  ...
  describe('ActivateLoyaltyPoints', function() {
    it('should create an instance of ActivateLoyaltyPoints', function() {
      // uncomment below and update the code to test ActivateLoyaltyPoints
      //var instane = new TalonOne.ActivateLoyaltyPoints();
      //expect(instance).to.be.a(TalonOne.ActivateLoyaltyPoints);
    });
