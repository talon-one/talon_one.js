...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AchievementV2();
  });
  ...
  describe('AchievementV2', function() {
    it('should create an instance of AchievementV2', function() {
      // uncomment below and update the code to test AchievementV2
      //var instane = new TalonOne.AchievementV2();
      //expect(instance).to.be.a(TalonOne.AchievementV2);
    });
