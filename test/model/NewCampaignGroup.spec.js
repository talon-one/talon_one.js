...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewCampaignGroup();
  });
  ...
  describe('NewCampaignGroup', function() {
    it('should create an instance of NewCampaignGroup', function() {
      // uncomment below and update the code to test NewCampaignGroup
      //var instane = new TalonOne.NewCampaignGroup();
      //expect(instance).to.be.a(TalonOne.NewCampaignGroup);
    });
