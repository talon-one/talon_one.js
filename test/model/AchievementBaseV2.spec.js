...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AchievementBaseV2();
  });
  ...
  describe('AchievementBaseV2', function() {
    it('should create an instance of AchievementBaseV2', function() {
      // uncomment below and update the code to test AchievementBaseV2
      //var instane = new TalonOne.AchievementBaseV2();
      //expect(instance).to.be.a(TalonOne.AchievementBaseV2);
    });
