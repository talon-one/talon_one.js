...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.NewCampaignSet();
  });
  ...
  describe('NewCampaignSet', function() {
    it('should create an instance of NewCampaignSet', function() {
      // uncomment below and update the code to test NewCampaignSet
      //var instane = new TalononeApi.NewCampaignSet();
      //expect(instance).to.be.a(TalononeApi.NewCampaignSet);
    });
