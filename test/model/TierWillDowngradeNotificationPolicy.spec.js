...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.TierWillDowngradeNotificationPolicy();
  });
  ...
  describe('TierWillDowngradeNotificationPolicy', function() {
    it('should create an instance of TierWillDowngradeNotificationPolicy', function() {
      // uncomment below and update the code to test TierWillDowngradeNotificationPolicy
      //var instane = new TalonOne.TierWillDowngradeNotificationPolicy();
      //expect(instance).to.be.a(TalonOne.TierWillDowngradeNotificationPolicy);
    });
