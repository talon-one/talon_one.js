...
(function(root, factory) {
  ...
  describe('NewCustomerSessionV2', function() {
    ...
    it('should have the property experimentVariantAllocations (base name: "experimentVariantAllocations")', function() {
      // uncomment below and update the code to test the property experimentVariantAllocations
      //var instane = new TalonOne.NewCustomerSessionV2();
      //expect(instance).to.be();
    });
