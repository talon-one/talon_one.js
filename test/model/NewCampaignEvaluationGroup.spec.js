...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewCampaignEvaluationGroup();
  });
  ...
  describe('NewCampaignEvaluationGroup', function() {
    it('should create an instance of NewCampaignEvaluationGroup', function() {
      // uncomment below and update the code to test NewCampaignEvaluationGroup
      //var instane = new TalonOne.NewCampaignEvaluationGroup();
      //expect(instance).to.be.a(TalonOne.NewCampaignEvaluationGroup);
    });
