...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.Picklist();
  });
  ...
  describe('Picklist', function() {
    it('should create an instance of Picklist', function() {
      // uncomment below and update the code to test Picklist
      //var instane = new TalonOne.Picklist();
      //expect(instance).to.be.a(TalonOne.Picklist);
    });
