...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationHubFlowWithConfig();
  });
  ...
  describe('IntegrationHubFlowWithConfig', function() {
    it('should create an instance of IntegrationHubFlowWithConfig', function() {
      // uncomment below and update the code to test IntegrationHubFlowWithConfig
      //var instane = new TalonOne.IntegrationHubFlowWithConfig();
      //expect(instance).to.be.a(TalonOne.IntegrationHubFlowWithConfig);
    });
