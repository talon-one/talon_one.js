...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.MiscUpdateUserLatestFeature();
  });
  ...
  describe('MiscUpdateUserLatestFeature', function() {
    it('should create an instance of MiscUpdateUserLatestFeature', function() {
      ...
      //var instane = new TalononeApi.MiscUpdateUserLatestFeature();
      //expect(instance).to.be.a(TalononeApi.MiscUpdateUserLatestFeature);
    });
