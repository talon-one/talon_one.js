...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.GiveawaysPool();
  });
  ...
  describe('GiveawaysPool', function() {
    it('should create an instance of GiveawaysPool', function() {
      // uncomment below and update the code to test GiveawaysPool
      //var instane = new TalonOne.GiveawaysPool();
      //expect(instance).to.be.a(TalonOne.GiveawaysPool);
    });
