...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewCustomEffect();
  });
  ...
  describe('NewCustomEffect', function() {
    it('should create an instance of NewCustomEffect', function() {
      // uncomment below and update the code to test NewCustomEffect
      //var instane = new TalonOne.NewCustomEffect();
      //expect(instance).to.be.a(TalonOne.NewCustomEffect);
    });
