...
(function(root, factory) {
  ...
  describe('Store', function() {
    it('should create an instance of Store', function() {
      ...
      //var instane = new TalonOne.Store();
      //expect(instance).to.be.a(TalonOne.Store);
    });
    ...
    it('should have the property linkedCampaignIds (base name: "linkedCampaignIds")', function() {
      // uncomment below and update the code to test the property linkedCampaignIds
      //var instane = new TalonOne.Store();
      //expect(instance).to.be();
    });
