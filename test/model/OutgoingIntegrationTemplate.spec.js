...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.OutgoingIntegrationTemplate();
  });
  ...
  describe('OutgoingIntegrationTemplate', function() {
    it('should create an instance of OutgoingIntegrationTemplate', function() {
      // uncomment below and update the code to test OutgoingIntegrationTemplate
      //var instane = new TalonOne.OutgoingIntegrationTemplate();
      //expect(instance).to.be.a(TalonOne.OutgoingIntegrationTemplate);
    });
