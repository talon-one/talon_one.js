...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CustomEffect();
  });
  ...
  describe('CustomEffect', function() {
    it('should create an instance of CustomEffect', function() {
      // uncomment below and update the code to test CustomEffect
      //var instane = new TalonOne.CustomEffect();
      //expect(instance).to.be.a(TalonOne.CustomEffect);
    });
