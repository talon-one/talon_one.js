...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.Loyalty();
  });
  ...
  describe('Loyalty', function() {
    it('should create an instance of Loyalty', function() {
      // uncomment below and update the code to test Loyalty
      //var instane = new TalononeApi.Loyalty();
      //expect(instance).to.be.a(TalononeApi.Loyalty);
    });
