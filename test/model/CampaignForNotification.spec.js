...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignForNotification();
  });
  ...
  describe('CampaignForNotification', function() {
    it('should create an instance of CampaignForNotification', function() {
      // uncomment below and update the code to test CampaignForNotification
      //var instane = new TalonOne.CampaignForNotification();
      //expect(instance).to.be.a(TalonOne.CampaignForNotification);
    });
