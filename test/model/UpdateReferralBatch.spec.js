...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.UpdateReferralBatch();
  });
  ...
  describe('UpdateReferralBatch', function() {
    it('should create an instance of UpdateReferralBatch', function() {
      // uncomment below and update the code to test UpdateReferralBatch
      //var instane = new TalonOne.UpdateReferralBatch();
      //expect(instance).to.be.a(TalonOne.UpdateReferralBatch);
    });
