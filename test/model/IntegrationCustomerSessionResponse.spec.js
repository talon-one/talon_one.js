...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationCustomerSessionResponse();
  });
  ...
  describe('IntegrationCustomerSessionResponse', function() {
    it('should create an instance of IntegrationCustomerSessionResponse', function() {
      // uncomment below and update the code to test IntegrationCustomerSessionResponse
      //var instane = new TalonOne.IntegrationCustomerSessionResponse();
      //expect(instance).to.be.a(TalonOne.IntegrationCustomerSessionResponse);
    });
