...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CardLedgerPointsEntryIntegrationAPI();
  });
  ...
  describe('CardLedgerPointsEntryIntegrationAPI', function() {
    it('should create an instance of CardLedgerPointsEntryIntegrationAPI', function() {
      // uncomment below and update the code to test CardLedgerPointsEntryIntegrationAPI
      //var instane = new TalonOne.CardLedgerPointsEntryIntegrationAPI();
      //expect(instance).to.be.a(TalonOne.CardLedgerPointsEntryIntegrationAPI);
    });
