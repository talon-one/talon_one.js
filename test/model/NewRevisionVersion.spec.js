...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewRevisionVersion();
  });
  ...
  describe('NewRevisionVersion', function() {
    it('should create an instance of NewRevisionVersion', function() {
      // uncomment below and update the code to test NewRevisionVersion
      //var instane = new TalonOne.NewRevisionVersion();
      //expect(instance).to.be.a(TalonOne.NewRevisionVersion);
    });
