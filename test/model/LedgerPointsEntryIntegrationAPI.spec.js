...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.LedgerPointsEntryIntegrationAPI();
  });
  ...
  describe('LedgerPointsEntryIntegrationAPI', function() {
    it('should create an instance of LedgerPointsEntryIntegrationAPI', function() {
      // uncomment below and update the code to test LedgerPointsEntryIntegrationAPI
      //var instane = new TalonOne.LedgerPointsEntryIntegrationAPI();
      //expect(instance).to.be.a(TalonOne.LedgerPointsEntryIntegrationAPI);
    });
