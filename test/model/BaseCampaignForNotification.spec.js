...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.BaseCampaignForNotification();
  });
  ...
  describe('BaseCampaignForNotification', function() {
    it('should create an instance of BaseCampaignForNotification', function() {
      // uncomment below and update the code to test BaseCampaignForNotification
      //var instane = new TalonOne.BaseCampaignForNotification();
      //expect(instance).to.be.a(TalonOne.BaseCampaignForNotification);
    });
