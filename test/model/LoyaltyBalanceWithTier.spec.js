...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.LoyaltyBalanceWithTier();
  });
  ...
  describe('LoyaltyBalanceWithTier', function() {
    it('should create an instance of LoyaltyBalanceWithTier', function() {
      // uncomment below and update the code to test LoyaltyBalanceWithTier
      //var instane = new TalonOne.LoyaltyBalanceWithTier();
      //expect(instance).to.be.a(TalonOne.LoyaltyBalanceWithTier);
    });
    ...
    it('should have the property projectedTier (base name: "projectedTier")', function() {
      // uncomment below and update the code to test the property projectedTier
      //var instane = new TalonOne.LoyaltyBalanceWithTier();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nextTierName (base name: "nextTierName")', function() {
