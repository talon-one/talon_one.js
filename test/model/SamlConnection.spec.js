...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.SamlConnection();
  });
  ...
  describe('SamlConnection', function() {
    it('should create an instance of SamlConnection', function() {
      // uncomment below and update the code to test SamlConnection
