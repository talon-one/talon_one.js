...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.NewCustomerSession();
  });
  ...
  describe('NewCustomerSession', function() {
    it('should create an instance of NewCustomerSession', function() {
      // uncomment below and update the code to test NewCustomerSession
      //var instane = new TalononeApi.NewCustomerSession();
      //expect(instance).to.be.a(TalononeApi.NewCustomerSession);
    });
