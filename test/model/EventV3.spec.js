...
(function(root, factory) {
  ...
  describe('EventV3', function() {
    it('should create an instance of EventV3', function() {
      // uncomment below and update the code to test EventV3
