...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AchievementProgressWithDefinition();
  });
  ...
  describe('AchievementProgressWithDefinition', function() {
    it('should create an instance of AchievementProgressWithDefinition', function() {
      // uncomment below and update the code to test AchievementProgressWithDefinition
      //var instane = new TalonOne.AchievementProgressWithDefinition();
      //expect(instance).to.be.a(TalonOne.AchievementProgressWithDefinition);
    });
