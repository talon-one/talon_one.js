...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AddedDeductedPointsBalancesAction();
  });
  ...
  describe('AddedDeductedPointsBalancesAction', function() {
    it('should create an instance of AddedDeductedPointsBalancesAction', function() {
      // uncomment below and update the code to test AddedDeductedPointsBalancesAction
      //var instane = new TalonOne.AddedDeductedPointsBalancesAction();
      //expect(instance).to.be.a(TalonOne.AddedDeductedPointsBalancesAction);
    });
