...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewMCPKey();
  });
  ...
  describe('NewMCPKey', function() {
    it('should create an instance of NewMCPKey', function() {
      // uncomment below and update the code to test NewMCPKey
      //var instane = new TalonOne.NewMCPKey();
      //expect(instance).to.be.a(TalonOne.NewMCPKey);
    });
