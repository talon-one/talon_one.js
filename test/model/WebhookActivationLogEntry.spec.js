...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.WebhookActivationLogEntry();
  });
  ...
  describe('WebhookActivationLogEntry', function() {
    it('should create an instance of WebhookActivationLogEntry', function() {
      ...
      //var instance = new TalonOne.WebhookActivationLogEntry();
      //expect(instance).to.be.a(TalonOne.WebhookActivationLogEntry);
    });
