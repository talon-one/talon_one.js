...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.WebhookActivationLogEntry();
  });
  ...
  describe('WebhookActivationLogEntry', function() {
    it('should create an instance of WebhookActivationLogEntry', function() {
      // uncomment below and update the code to test WebhookActivationLogEntry
      //var instane = new TalononeApi.WebhookActivationLogEntry();
      //expect(instance).to.be.a(TalononeApi.WebhookActivationLogEntry);
    });
