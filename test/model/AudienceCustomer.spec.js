...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AudienceCustomer();
  });
  ...
  describe('AudienceCustomer', function() {
    it('should create an instance of AudienceCustomer', function() {
      // uncomment below and update the code to test AudienceCustomer
      //var instane = new TalonOne.AudienceCustomer();
      //expect(instance).to.be.a(TalonOne.AudienceCustomer);
    });
    ...
    it('should have the property connectedApplicationsIds (base name: "connectedApplicationsIds")', function() {
      // uncomment below and update the code to test the property connectedApplicationsIds
      //var instane = new TalonOne.AudienceCustomer();
      //expect(instance).to.be();
    });

    it('should have the property connectedAudiences (base name: "connectedAudiences")', function() {
      // uncomment below and update the code to test the property connectedAudiences
      //var instane = new TalonOne.AudienceCustomer();
      //expect(instance).to.be();
    });
