...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.LoyaltyBalance();
  });
  ...
  describe('LoyaltyBalance', function() {
    it('should create an instance of LoyaltyBalance', function() {
      // uncomment below and update the code to test LoyaltyBalance
      //var instane = new TalonOne.LoyaltyBalance();
      //expect(instance).to.be.a(TalonOne.LoyaltyBalance);
    });
