...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CardExpiringPointsNotificationPolicy();
  });
  ...
  describe('CardExpiringPointsNotificationPolicy', function() {
    it('should create an instance of CardExpiringPointsNotificationPolicy', function() {
      // uncomment below and update the code to test CardExpiringPointsNotificationPolicy
      //var instane = new TalonOne.CardExpiringPointsNotificationPolicy();
      //expect(instance).to.be.a(TalonOne.CardExpiringPointsNotificationPolicy);
    });
