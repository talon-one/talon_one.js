...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AccountDashboardStatistic();
  });
  ...
  describe('AccountDashboardStatistic', function() {
    it('should create an instance of AccountDashboardStatistic', function() {
      // uncomment below and update the code to test AccountDashboardStatistic
      //var instane = new TalonOne.AccountDashboardStatistic();
      //expect(instance).to.be.a(TalonOne.AccountDashboardStatistic);
    });
