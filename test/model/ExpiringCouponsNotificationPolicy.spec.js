...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ExpiringCouponsNotificationPolicy();
  });
  ...
  describe('ExpiringCouponsNotificationPolicy', function() {
    it('should create an instance of ExpiringCouponsNotificationPolicy', function() {
      // uncomment below and update the code to test ExpiringCouponsNotificationPolicy
      //var instane = new TalonOne.ExpiringCouponsNotificationPolicy();
      //expect(instance).to.be.a(TalonOne.ExpiringCouponsNotificationPolicy);
    });
