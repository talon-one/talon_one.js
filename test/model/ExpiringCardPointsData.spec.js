...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ExpiringCardPointsData();
  });
  ...
  describe('ExpiringCardPointsData', function() {
    it('should create an instance of ExpiringCardPointsData', function() {
      // uncomment below and update the code to test ExpiringCardPointsData
      //var instane = new TalonOne.ExpiringCardPointsData();
      //expect(instance).to.be.a(TalonOne.ExpiringCardPointsData);
    });
