...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CustomerProfileSearchQuery();
  });
  ...
  describe('CustomerProfileSearchQuery', function() {
    it('should create an instance of CustomerProfileSearchQuery', function() {
      // uncomment below and update the code to test CustomerProfileSearchQuery
      //var instane = new TalononeApi.CustomerProfileSearchQuery();
      //expect(instance).to.be.a(TalononeApi.CustomerProfileSearchQuery);
    });
