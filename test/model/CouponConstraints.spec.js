...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CouponConstraints();
  });
  ...
  describe('CouponConstraints', function() {
    it('should create an instance of CouponConstraints', function() {
      // uncomment below and update the code to test CouponConstraints
      //var instane = new TalononeApi.CouponConstraints();
      //expect(instance).to.be.a(TalononeApi.CouponConstraints);
    });
