...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewManagementKey();
  });
  ...
  describe('NewManagementKey', function() {
    it('should create an instance of NewManagementKey', function() {
      // uncomment below and update the code to test NewManagementKey
      //var instane = new TalonOne.NewManagementKey();
      //expect(instance).to.be.a(TalonOne.NewManagementKey);
    });
