...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.FunctionDef();
  });
  ...
  describe('FunctionDef', function() {
    it('should create an instance of FunctionDef', function() {
      // uncomment below and update the code to test FunctionDef
      //var instane = new TalononeApi.FunctionDef();
      //expect(instance).to.be.a(TalononeApi.FunctionDef);
    });
