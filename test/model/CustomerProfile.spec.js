...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CustomerProfile();
  });
  ...
  describe('CustomerProfile', function() {
    it('should create an instance of CustomerProfile', function() {
      // uncomment below and update the code to test CustomerProfile
      //var instane = new TalononeApi.CustomerProfile();
      //expect(instance).to.be.a(TalononeApi.CustomerProfile);
    });
