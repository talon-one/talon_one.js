...
(function(root, factory) {
  ...
  describe('CouponCreationJob', function() {
    ...
    it('should have the property chunkExecutionCount (base name: "chunkExecutionCount")', function() {
      // uncomment below and update the code to test the property chunkExecutionCount
      //var instane = new TalonOne.CouponCreationJob();
      //expect(instance).to.be();
    });
