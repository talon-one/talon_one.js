...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification();
  });
  ...
  describe('IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification', function() {
    it('should create an instance of IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification', function() {
      // uncomment below and update the code to test IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification
