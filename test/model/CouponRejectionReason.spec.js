...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CouponRejectionReason();
  });
  ...
  describe('CouponRejectionReason', function() {
    it('should create an instance of CouponRejectionReason', function() {
      // uncomment below and update the code to test CouponRejectionReason
      //var instane = new TalononeApi.CouponRejectionReason();
      //expect(instance).to.be.a(TalononeApi.CouponRejectionReason);
    });
