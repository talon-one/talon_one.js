...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ExperimentResult();
  });
  ...
  describe('ExperimentResult', function() {
    it('should create an instance of ExperimentResult', function() {
      // uncomment below and update the code to test ExperimentResult
      //var instane = new TalonOne.ExperimentResult();
      //expect(instance).to.be.a(TalonOne.ExperimentResult);
    });
