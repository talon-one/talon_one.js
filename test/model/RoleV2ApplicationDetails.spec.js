...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.RoleV2ApplicationDetails();
  });
  ...
  describe('RoleV2ApplicationDetails', function() {
    it('should create an instance of RoleV2ApplicationDetails', function() {
      // uncomment below and update the code to test RoleV2ApplicationDetails
      //var instane = new TalonOne.RoleV2ApplicationDetails();
      //expect(instance).to.be.a(TalonOne.RoleV2ApplicationDetails);
    });
    ...
    it('should have the property draftCampaign (base name: "draftCampaign")', function() {
      // uncomment below and update the code to test the property draftCampaign
      //var instane = new TalonOne.RoleV2ApplicationDetails();
      //expect(instance).to.be();
    });
