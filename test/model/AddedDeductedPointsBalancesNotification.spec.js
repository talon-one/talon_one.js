...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AddedDeductedPointsBalancesNotification();
  });
  ...
  describe('AddedDeductedPointsBalancesNotification', function() {
    it('should create an instance of AddedDeductedPointsBalancesNotification', function() {
      // uncomment below and update the code to test AddedDeductedPointsBalancesNotification
      //var instane = new TalonOne.AddedDeductedPointsBalancesNotification();
      //expect(instance).to.be.a(TalonOne.AddedDeductedPointsBalancesNotification);
    });
