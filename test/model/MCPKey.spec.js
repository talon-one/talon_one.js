...
(function(root, factory) {
  ...
  describe('MCPKey', function() {
    it('should create an instance of MCPKey', function() {
      // uncomment below and update the code to test MCPKey
      //var instane = new TalonOne.MCPKey();
      //expect(instance).to.be.a(TalonOne.MCPKey);
    });
