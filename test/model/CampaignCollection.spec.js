...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignCollection();
  });
  ...
  describe('CampaignCollection', function() {
    it('should create an instance of CampaignCollection', function() {
      // uncomment below and update the code to test CampaignCollection
      //var instane = new TalonOne.CampaignCollection();
      //expect(instance).to.be.a(TalonOne.CampaignCollection);
    });
