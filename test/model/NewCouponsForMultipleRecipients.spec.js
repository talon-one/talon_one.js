...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewCouponsForMultipleRecipients();
  });
  ...
  describe('NewCouponsForMultipleRecipients', function() {
    it('should create an instance of NewCouponsForMultipleRecipients', function() {
      // uncomment below and update the code to test NewCouponsForMultipleRecipients
      //var instane = new TalonOne.NewCouponsForMultipleRecipients();
      //expect(instance).to.be.a(TalonOne.NewCouponsForMultipleRecipients);
    });
    ...
    it('should have the property recipientsIntegrationIds (base name: "recipientsIntegrationIds")', function() {
      // uncomment below and update the code to test the property recipientsIntegrationIds
      //var instane = new TalonOne.NewCouponsForMultipleRecipients();
      //expect(instance).to.be();
    });
