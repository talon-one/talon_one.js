...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationEventV2Response();
  });
  ...
  describe('IntegrationEventV2Response', function() {
    it('should create an instance of IntegrationEventV2Response', function() {
      // uncomment below and update the code to test IntegrationEventV2Response
      //var instane = new TalonOne.IntegrationEventV2Response();
      //expect(instance).to.be.a(TalonOne.IntegrationEventV2Response);
    });
