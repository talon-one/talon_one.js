...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.LoyaltyProgramBalance();
  });
  ...
  describe('LoyaltyProgramBalance', function() {
    it('should create an instance of LoyaltyProgramBalance', function() {
      ...
      //var instane = new TalononeApi.LoyaltyProgramBalance();
      //expect(instance).to.be.a(TalononeApi.LoyaltyProgramBalance);
    });
