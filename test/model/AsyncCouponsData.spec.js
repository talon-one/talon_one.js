...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AsyncCouponsData();
  });
  ...
  describe('AsyncCouponsData', function() {
    it('should create an instance of AsyncCouponsData', function() {
      // uncomment below and update the code to test AsyncCouponsData
      //var instane = new TalonOne.AsyncCouponsData();
      //expect(instance).to.be.a(TalonOne.AsyncCouponsData);
    });
