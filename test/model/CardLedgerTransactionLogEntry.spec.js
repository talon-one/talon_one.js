...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CardLedgerTransactionLogEntry();
  });
  ...
  describe('CardLedgerTransactionLogEntry', function() {
    it('should create an instance of CardLedgerTransactionLogEntry', function() {
      // uncomment below and update the code to test CardLedgerTransactionLogEntry
      //var instane = new TalonOne.CardLedgerTransactionLogEntry();
      //expect(instance).to.be.a(TalonOne.CardLedgerTransactionLogEntry);
    });
