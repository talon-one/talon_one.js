...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.RuleFailureReason();
  });
  ...
  describe('RuleFailureReason', function() {
    it('should create an instance of RuleFailureReason', function() {
      // uncomment below and update the code to test RuleFailureReason
      //var instane = new TalonOne.RuleFailureReason();
      //expect(instance).to.be.a(TalonOne.RuleFailureReason);
    });
