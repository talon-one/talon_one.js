...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewRuleset();
  });
  ...
  describe('NewRuleset', function() {
    it('should create an instance of NewRuleset', function() {
      // uncomment below and update the code to test NewRuleset
      //var instane = new TalonOne.NewRuleset();
      //expect(instance).to.be.a(TalonOne.NewRuleset);
    });
