...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignDeletedNotification();
  });
  ...
  describe('CampaignDeletedNotification', function() {
    it('should create an instance of CampaignDeletedNotification', function() {
      // uncomment below and update the code to test CampaignDeletedNotification
