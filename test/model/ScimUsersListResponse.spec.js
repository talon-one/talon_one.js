...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ScimUsersListResponse();
  });
  ...
  describe('ScimUsersListResponse', function() {
    it('should create an instance of ScimUsersListResponse', function() {
      // uncomment below and update the code to test ScimUsersListResponse
      //var instane = new TalonOne.ScimUsersListResponse();
      //expect(instance).to.be.a(TalonOne.ScimUsersListResponse);
    });
