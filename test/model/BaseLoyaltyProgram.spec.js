...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.BaseLoyaltyProgram();
  });
  ...
  describe('BaseLoyaltyProgram', function() {
    it('should create an instance of BaseLoyaltyProgram', function() {
      // uncomment below and update the code to test BaseLoyaltyProgram
      //var instane = new TalonOne.BaseLoyaltyProgram();
      //expect(instance).to.be.a(TalonOne.BaseLoyaltyProgram);
    });
