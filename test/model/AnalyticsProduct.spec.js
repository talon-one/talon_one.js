...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AnalyticsProduct();
  });
  ...
  describe('AnalyticsProduct', function() {
    it('should create an instance of AnalyticsProduct', function() {
      // uncomment below and update the code to test AnalyticsProduct
      //var instane = new TalonOne.AnalyticsProduct();
      //expect(instance).to.be.a(TalonOne.AnalyticsProduct);
    });
