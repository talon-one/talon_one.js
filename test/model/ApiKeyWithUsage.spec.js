...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.ApiKeyWithUsage();
  });
  ...
  describe('ApiKeyWithUsage', function() {
    it('should create an instance of ApiKeyWithUsage', function() {
      // uncomment below and update the code to test ApiKeyWithUsage
      //var instane = new TalononeApi.ApiKeyWithUsage();
      //expect(instance).to.be.a(TalononeApi.ApiKeyWithUsage);
    });
