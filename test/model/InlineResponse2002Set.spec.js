...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.InlineResponse2002Set();
  });
  ...
  describe('InlineResponse2002Set', function() {
    it('should create an instance of InlineResponse2002Set', function() {
      // uncomment below and update the code to test InlineResponse2002Set
      //var instane = new TalononeApi.InlineResponse2002Set();
      //expect(instance).to.be.a(TalononeApi.InlineResponse2002Set);
    });
