...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ScimSchemasListResponse();
  });
  ...
  describe('ScimSchemasListResponse', function() {
    it('should create an instance of ScimSchemasListResponse', function() {
      // uncomment below and update the code to test ScimSchemasListResponse
      //var instane = new TalonOne.ScimSchemasListResponse();
      //expect(instance).to.be.a(TalonOne.ScimSchemasListResponse);
    });
