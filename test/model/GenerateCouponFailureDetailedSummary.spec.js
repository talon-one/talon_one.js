...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.GenerateCouponFailureDetailedSummary();
  });
  ...
  describe('GenerateCouponFailureDetailedSummary', function() {
    it('should create an instance of GenerateCouponFailureDetailedSummary', function() {
      // uncomment below and update the code to test GenerateCouponFailureDetailedSummary
      //var instane = new TalonOne.GenerateCouponFailureDetailedSummary();
      //expect(instance).to.be.a(TalonOne.GenerateCouponFailureDetailedSummary);
    });
