...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewNotificationTest();
  });
  ...
  describe('NewNotificationTest', function() {
    it('should create an instance of NewNotificationTest', function() {
      // uncomment below and update the code to test NewNotificationTest
      //var instane = new TalonOne.NewNotificationTest();
      //expect(instance).to.be.a(TalonOne.NewNotificationTest);
    });
