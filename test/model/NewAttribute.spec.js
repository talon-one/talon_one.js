...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.NewAttribute();
  });
  ...
  describe('NewAttribute', function() {
    it('should create an instance of NewAttribute', function() {
      // uncomment below and update the code to test NewAttribute
      //var instane = new TalononeApi.NewAttribute();
      //expect(instance).to.be.a(TalononeApi.NewAttribute);
    });
