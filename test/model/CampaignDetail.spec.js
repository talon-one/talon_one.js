...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignDetail();
  });
  ...
  describe('CampaignDetail', function() {
    it('should create an instance of CampaignDetail', function() {
      // uncomment below and update the code to test CampaignDetail
      //var instane = new TalonOne.CampaignDetail();
      //expect(instance).to.be.a(TalonOne.CampaignDetail);
    });
