...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.GenerateCampaignDescription();
  });
  ...
  describe('GenerateCampaignDescription', function() {
    it('should create an instance of GenerateCampaignDescription', function() {
      // uncomment below and update the code to test GenerateCampaignDescription
