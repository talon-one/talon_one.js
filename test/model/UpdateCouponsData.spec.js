...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.UpdateCouponsData();
  });
  ...
  describe('UpdateCouponsData', function() {
    it('should create an instance of UpdateCouponsData', function() {
      // uncomment below and update the code to test UpdateCouponsData
      //var instane = new TalonOne.UpdateCouponsData();
      //expect(instance).to.be.a(TalonOne.UpdateCouponsData);
    });
