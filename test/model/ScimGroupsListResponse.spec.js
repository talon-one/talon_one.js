...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ScimGroupsListResponse();
  });
  ...
  describe('ScimGroupsListResponse', function() {
    it('should create an instance of ScimGroupsListResponse', function() {
      // uncomment below and update the code to test ScimGroupsListResponse
      //var instane = new TalonOne.ScimGroupsListResponse();
      //expect(instance).to.be.a(TalonOne.ScimGroupsListResponse);
    });
