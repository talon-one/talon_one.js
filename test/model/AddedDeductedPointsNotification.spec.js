...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AddedDeductedPointsNotification();
  });
  ...
  describe('AddedDeductedPointsNotification', function() {
    it('should create an instance of AddedDeductedPointsNotification', function() {
      // uncomment below and update the code to test AddedDeductedPointsNotification
      //var instane = new TalonOne.AddedDeductedPointsNotification();
      //expect(instance).to.be.a(TalonOne.AddedDeductedPointsNotification);
    });
