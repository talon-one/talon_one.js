...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignCollectionWithoutPayload();
  });
  ...
  describe('CampaignCollectionWithoutPayload', function() {
    it('should create an instance of CampaignCollectionWithoutPayload', function() {
      // uncomment below and update the code to test CampaignCollectionWithoutPayload
      //var instane = new TalonOne.CampaignCollectionWithoutPayload();
      //expect(instance).to.be.a(TalonOne.CampaignCollectionWithoutPayload);
    });
