...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CampaignSetBranchNode();
  });
  ...
  describe('CampaignSetBranchNode', function() {
    it('should create an instance of CampaignSetBranchNode', function() {
      // uncomment below and update the code to test CampaignSetBranchNode
      //var instane = new TalononeApi.CampaignSetBranchNode();
      //expect(instance).to.be.a(TalononeApi.CampaignSetBranchNode);
    });
