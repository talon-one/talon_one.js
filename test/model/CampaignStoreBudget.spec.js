...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignStoreBudget();
  });
  ...
  describe('CampaignStoreBudget', function() {
    it('should create an instance of CampaignStoreBudget', function() {
      // uncomment below and update the code to test CampaignStoreBudget
      //var instane = new TalonOne.CampaignStoreBudget();
      //expect(instance).to.be.a(TalonOne.CampaignStoreBudget);
    });
