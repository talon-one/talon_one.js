...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CatalogRule();
  });
  ...
  describe('CatalogRule', function() {
    it('should create an instance of CatalogRule', function() {
      // uncomment below and update the code to test CatalogRule
      //var instane = new TalonOne.CatalogRule();
      //expect(instance).to.be.a(TalonOne.CatalogRule);
    });
