...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CouponsNotificationData();
  });
  ...
  describe('CouponsNotificationData', function() {
    it('should create an instance of CouponsNotificationData', function() {
      // uncomment below and update the code to test CouponsNotificationData
      //var instane = new TalonOne.CouponsNotificationData();
      //expect(instance).to.be.a(TalonOne.CouponsNotificationData);
    });
