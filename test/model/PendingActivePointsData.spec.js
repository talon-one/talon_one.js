...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.PendingActivePointsData();
  });
  ...
  describe('PendingActivePointsData', function() {
    it('should create an instance of PendingActivePointsData', function() {
      // uncomment below and update the code to test PendingActivePointsData
      //var instane = new TalonOne.PendingActivePointsData();
      //expect(instance).to.be.a(TalonOne.PendingActivePointsData);
    });
    ...
    it('should have the property activeOn (base name: "ActiveOn")', function() {
      // uncomment below and update the code to test the property activeOn
      //var instane = new TalonOne.PendingActivePointsData();
      //expect(instance).to.be();
    });
