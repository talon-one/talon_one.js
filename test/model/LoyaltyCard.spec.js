...
(function(root, factory) {
  ...
  describe('LoyaltyCard', function() {
    ...
    it('should have the property oldCardIdentifier (base name: "oldCardIdentifier")', function() {
      // uncomment below and update the code to test the property oldCardIdentifier
      //var instane = new TalonOne.LoyaltyCard();
      //expect(instance).to.be();
    });
