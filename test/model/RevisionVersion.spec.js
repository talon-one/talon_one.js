...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.RevisionVersion();
  });
  ...
  describe('RevisionVersion', function() {
    it('should create an instance of RevisionVersion', function() {
      // uncomment below and update the code to test RevisionVersion
      //var instane = new TalonOne.RevisionVersion();
      //expect(instance).to.be.a(TalonOne.RevisionVersion);
    });
