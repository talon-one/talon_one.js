...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AdjustmentDetails();
  });
  ...
  describe('AdjustmentDetails', function() {
    it('should create an instance of AdjustmentDetails', function() {
      // uncomment below and update the code to test AdjustmentDetails
      //var instane = new TalonOne.AdjustmentDetails();
      //expect(instance).to.be.a(TalonOne.AdjustmentDetails);
    });
