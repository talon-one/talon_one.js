...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.InlineResponse2003Rules();
  });
  ...
  describe('InlineResponse2003Rules', function() {
    it('should create an instance of InlineResponse2003Rules', function() {
      // uncomment below and update the code to test InlineResponse2003Rules
      //var instane = new TalononeApi.InlineResponse2003Rules();
      //expect(instance).to.be.a(TalononeApi.InlineResponse2003Rules);
    });
