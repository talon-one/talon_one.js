...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CampaignSet();
  });
  ...
  describe('CampaignSet', function() {
    it('should create an instance of CampaignSet', function() {
      // uncomment below and update the code to test CampaignSet
      //var instane = new TalononeApi.CampaignSet();
      //expect(instance).to.be.a(TalononeApi.CampaignSet);
    });
