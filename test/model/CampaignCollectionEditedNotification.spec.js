...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CampaignCollectionEditedNotification();
  });
  ...
  describe('CampaignCollectionEditedNotification', function() {
    it('should create an instance of CampaignCollectionEditedNotification', function() {
      // uncomment below and update the code to test CampaignCollectionEditedNotification
