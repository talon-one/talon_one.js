...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CreateAchievementV2();
  });
  ...
  describe('CreateAchievementV2', function() {
    it('should create an instance of CreateAchievementV2', function() {
      // uncomment below and update the code to test CreateAchievementV2
      //var instane = new TalonOne.CreateAchievementV2();
      //expect(instance).to.be.a(TalonOne.CreateAchievementV2);
    });
