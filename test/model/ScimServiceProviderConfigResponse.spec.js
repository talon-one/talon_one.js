...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ScimServiceProviderConfigResponse();
  });
  ...
  describe('ScimServiceProviderConfigResponse', function() {
    it('should create an instance of ScimServiceProviderConfigResponse', function() {
      // uncomment below and update the code to test ScimServiceProviderConfigResponse
      //var instane = new TalonOne.ScimServiceProviderConfigResponse();
      //expect(instance).to.be.a(TalonOne.ScimServiceProviderConfigResponse);
    });
