...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AchievementReference();
  });
  ...
  describe('AchievementReference', function() {
    it('should create an instance of AchievementReference', function() {
      // uncomment below and update the code to test AchievementReference
      //var instane = new TalonOne.AchievementReference();
      //expect(instance).to.be.a(TalonOne.AchievementReference);
    });
