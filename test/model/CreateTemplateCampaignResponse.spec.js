...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.CreateTemplateCampaignResponse();
  });
  ...
  describe('CreateTemplateCampaignResponse', function() {
    it('should create an instance of CreateTemplateCampaignResponse', function() {
      // uncomment below and update the code to test CreateTemplateCampaignResponse
      //var instane = new TalonOne.CreateTemplateCampaignResponse();
      //expect(instance).to.be.a(TalonOne.CreateTemplateCampaignResponse);
    });
