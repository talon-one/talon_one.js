...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.ExperimentSegmentInsight();
  });
  ...
  describe('ExperimentSegmentInsight', function() {
    it('should create an instance of ExperimentSegmentInsight', function() {
      // uncomment below and update the code to test ExperimentSegmentInsight
      //var instane = new TalonOne.ExperimentSegmentInsight();
      //expect(instance).to.be.a(TalonOne.ExperimentSegmentInsight);
    });
    ...
    it('should have the property winnerVariantId (base name: "winnerVariantId")', function() {
      // uncomment below and update the code to test the property winnerVariantId
      //var instane = new TalonOne.ExperimentSegmentInsight();
      //expect(instance).to.be();
    });
