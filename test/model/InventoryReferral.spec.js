...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.InventoryReferral();
  });
  ...
  describe('InventoryReferral', function() {
    it('should create an instance of InventoryReferral', function() {
      // uncomment below and update the code to test InventoryReferral
      //var instane = new TalonOne.InventoryReferral();
      //expect(instance).to.be.a(TalonOne.InventoryReferral);
    });
    ...
    it('should have the property referredCustomers (base name: "referredCustomers")', function() {
