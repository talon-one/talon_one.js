...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AchievementStatusEntry();
  });
  ...
  describe('AchievementStatusEntry', function() {
    it('should create an instance of AchievementStatusEntry', function() {
      // uncomment below and update the code to test AchievementStatusEntry
      //var instane = new TalonOne.AchievementStatusEntry();
      //expect(instance).to.be.a(TalonOne.AchievementStatusEntry);
    });
