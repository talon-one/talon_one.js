...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.IntegrationCampaign();
  });
  ...
  describe('IntegrationCampaign', function() {
    it('should create an instance of IntegrationCampaign', function() {
      // uncomment below and update the code to test IntegrationCampaign
