...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalononeApi.CustomerActivityReport();
  });
  ...
  describe('CustomerActivityReport', function() {
    it('should create an instance of CustomerActivityReport', function() {
      ...
      //var instane = new TalononeApi.CustomerActivityReport();
      //expect(instance).to.be.a(TalononeApi.CustomerActivityReport);
    });
