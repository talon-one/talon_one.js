...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.AchievementAdditionalProperties();
  });
  ...
  describe('AchievementAdditionalProperties', function() {
    it('should create an instance of AchievementAdditionalProperties', function() {
      // uncomment below and update the code to test AchievementAdditionalProperties
      //var instane = new TalonOne.AchievementAdditionalProperties();
      //expect(instance).to.be.a(TalonOne.AchievementAdditionalProperties);
    });
