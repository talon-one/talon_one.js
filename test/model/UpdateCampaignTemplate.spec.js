...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.UpdateCampaignTemplate();
  });
  ...
  describe('UpdateCampaignTemplate', function() {
    it('should create an instance of UpdateCampaignTemplate', function() {
      // uncomment below and update the code to test UpdateCampaignTemplate
      //var instane = new TalonOne.UpdateCampaignTemplate();
      //expect(instance).to.be.a(TalonOne.UpdateCampaignTemplate);
    });
