...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TalonOne.NewReward();
  });
  ...
  describe('NewReward', function() {
    it('should create an instance of NewReward', function() {
      // uncomment below and update the code to test NewReward
      //var instane = new TalonOne.NewReward();
      //expect(instance).to.be.a(TalonOne.NewReward);
    });
